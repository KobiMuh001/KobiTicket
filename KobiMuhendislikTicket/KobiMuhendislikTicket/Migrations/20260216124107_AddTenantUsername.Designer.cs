...
namespace KobiMuhendislikTicket.Migrations
{
    ...
    [Migration("20260216124107_AddTenantUsername")]
    partial class AddTenantUsername
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KobiMuhendislikTicket.Domain.Entities.Staff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$hikAL20jzs.cMkFXPhXtuOzZhKRGn25Zsev28bToiTLPdaJdNUiRi",
                            Phone = "(532) 111 2233"
                        },
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$4cSAKuXMwaOLvWgSEBG5L.o8PGd2Rq6ImmPYAeN8LFpv5GSY7Zvbu",
                            Phone = "(533) 222 3344"
                        },
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$7anXae85HwHLvPo1U6c8B.FAnhtrC0HT6bFttVIjJ1lUOUSereM82",
                            Phone = "(534) 333 4455"
                        });
                });
